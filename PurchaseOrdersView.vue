<template>
  <div class="form-page">
    ...
    <form class="project-form" @submit.prevent="handleSubmit">
      ...
      <FormField v-model="form.shippingContactName" label="Shipping Contact" placeholder="Receiving or ship-to POC" />
      <FormField v-model="form.shippingEmail" label="Shipping Email" placeholder="receiving@example.com" type="email" />
      ...
      <label class="form-field span-2">
        ...
        <textarea v-model="form.deliveryAddress" placeholder="Warehouse or customer delivery location" />
      </label>
      <label class="form-field span-2">
