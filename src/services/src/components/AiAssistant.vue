    ...
    <aside class="atlas-drawer" aria-label="Atlas assistant">
      <header class="atlas-header">
        <div class="atlas-title-row">
          ...
          <div>
            <h2>Atlas</h2>
            <p>Projects, quotes, POs, tracking</p>
          </div>
        </div>
      ...
      <div class="atlas-composer-panel">
        ...
        <form class="atlas-composer" @submit.prevent="submitQuestion()">
          <textarea
            v-model="input"
            placeholder="Ask about a project, quote, PO, or tracking..."
...
const starters = [
  ...
  'Which vendor updates are needed?',
...
const messages = ref<AssistantMessage[]>([
  {
    role: 'assistant',
    content: 'Hi, I am Atlas, the Cronos AI assistant. Ask me about projects, quotes, POs, vendor tracking, or customer updates.',
  },
])
